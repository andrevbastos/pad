...
do
    ...
    perf stat -e cache-misses,cache-references,L1-dcache-load-misses,LLC-load-misses,branches,branch-misses \
        ...
        /home/andre/projects/pad/build/bin/pad engine paralelo &
    PAD_PID=$!
    wait $PAD_PID 
    ...
    taskset -c 2 perf stat -e cache-misses,cache-references,L1-dcache-load-misses,LLC-load-misses,branches,branch-misses \
        ...
        /home/andre/projects/pad/build/bin/pad engine sequencial &
    PAD_PID=$!
    wait $PAD_PID

    mkdir -p /home/andre/facul/programacao-de-alto-desempenho/engine/$i
    mv /home/andre/projects/pad/results/* /home/andre/facul/programacao-de-alto-desempenho/engine/$i
done
